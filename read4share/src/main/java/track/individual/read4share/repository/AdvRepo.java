...
public interface AdvRepo extends JpaRepository<Advertisement, Long> {
    ...
    @Query("select adv.book.title, adv.book.author, adv.seller.username, " +
            "adv.city.name, adv.price, adv.publDate, adv.book.coverPath " +
            "from Advertisement adv where adv.saleDate is null " +
    ...
    @Query("select adv.book.title, adv.book.author, adv.seller.username, " +
            "adv.city.name, adv.price, adv.publDate, adv.book.coverPath " +
            "from Advertisement adv where adv.price = 0.0 " +
            "order by adv.publDate desc")
    ...
    @Query("select adv.book.title, adv.book.author, adv.seller.username, " +
            "adv.city.name, adv.price, adv.publDate, adv.book.coverPath " +
            "from Advertisement adv where adv.shipCost = 0.0 " +
            "order by adv.publDate desc")
    ...
    @Query("select adv.book.title, adv.book.author, adv.seller.username, " +
            "adv.city.name, adv.price, adv.publDate, adv.book.coverPath " +
            "from Advertisement adv where adv.condition.code = 'AN' " +
            "order by adv.publDate desc")
